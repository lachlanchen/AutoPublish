...
alias start_chrome_shipinhao='DISPLAY=:0 google-chrome --hide-crash-restore-bubble --remote-debugging-port=5006 --user-data-dir="$HOME/chrome_dev_session_5006" https://channels.weixin.qq.com/platform/post/create > "$HOME/chrome_dev_session_logs/chrome_shipinhao.log" 2>&1'
